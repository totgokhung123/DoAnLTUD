    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/giamgia/edit/**","/cart/**","/single/**","/search-products","/","/webchinh/**","/image/**","/css/**", "/js/**","/img/**","/vendor/**","/forgot-password","/reset-password","auth/login-success","/auth-login-basic","/assets/**", "/register","/public/**", "/error/**", "/auth/**", "/oauth2/**","/policy")
                        .permitAll()
                        .requestMatchers("/products","/products/add","/products/edit","/products/delete","/userlist","/userlist/add","/edit", "/books/delete", "/categories/edit", "/categories/delete","/","/policy/edit/**", "/policy/add", "/policy/delete/**")
